...
@RestController
@RequestMapping("/api/my-backend-app-kafka")
public class MyBackendAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyBackendAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyBackendAppKafkaResource(KafkaProperties kafkaProperties) {
